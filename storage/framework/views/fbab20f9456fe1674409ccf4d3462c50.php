<?php $__env->startSection('title', $user->name . ' — ' . ($settings['site_name'] ?? 'ADT Sports')); ?>
<?php $__env->startSection('meta_desc', $user->bio ?: ('Articles, analysis and reporting by ' . $user->name . ' on ' . ($settings['site_name'] ?? 'ADT Sports'))); ?>

<?php $__env->startSection('canonical', $articles->currentPage() > 1 ? $articles->url($articles->currentPage()) : route('author', $user->id)); ?>
...
<div class="wrap">
  ...
  <div style="padding:40px 0 8px;border-bottom:3px solid var(--brand);margin-bottom:32px">
    ...
    <?php if($user->bio): ?>
      <p style="font-size:16px;color:var(--ink2);max-width:600px;line-height:1.6"><?php echo e($user->bio); ?></p>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\4yush\OneDrive\Desktop\hehe\adt-sports\resources\views/frontend/author.blade.php ENDPATH**/ ?>